...
## アドレスの解釈
<img width="1891" alt="スクリーンショット 2023-06-11 17 56 48" src="https://github.com/junyaU/os_study_memo/assets/61627945/20493e44-7897-4ece-89dd-632894bbd340">
...
### ページテーブルインデックスとページオフセット
仮想アドレスの47:12ビットは、9ビットずつに分割され、それぞれのページテーブルのインデックスとして扱われる。\
具体的には、
- **47:39ビット** - PML4 Tableのインデックス
- **38:30ビット** - PDP Tableのインデックス
- **29:21ビット** - PD Tableのインデックス
- **20:12ビット** - Page Tableのインデックス

となる。

また、仮想アドレスの11:0ビットは、ページオフセットとして扱われる。\
ページオフセットは、フレームアドレスに足すことで、物理アドレスを取得することができる。

<img width="1536" alt="スクリーンショット 2023-06-11 20 28 30" src="https://github.com/junyaU/os_study_memo/assets/61627945/135c753a-2726-4b94-96b0-8554a15beaea">

**0xFFFF80001E141F3C**の場合、
- **47:39ビット** - 0x1E = 30　→　PML4 Table[30]を参照
- **38:30ビット** - 0x14 = 20　→　PDP Table[20]を参照
- **29:21ビット** - 0x1 = 1　→　PD Table[1]を参照
- **20:12ビット** - 0xF = 15　→　Page Table[15]を参照
- **11:0ビット** - 0x3C = 60　→　フレームアドレスから60バイト目を参照

となり、ページテーブルが指しているフレームアドレスが、0x200000なので、\
**0x200000 + 0x3C = 0x20003C** となり、これが物理アドレスとなる。